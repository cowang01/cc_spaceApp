<template>
  <div id="app">
    <map name="planetmap">
      ...
      <area shape="poly" coords="0,144,26,158,47,170,83,196,129,236,163,277,188,316,211,364,228,418,233,473,235,510,229,547,220,596,209,632,192,668,174,699,148,736,129,760,94,788,61,812,19,835,1,843" alt="Mercury" v-on:click="sendName('Mercury')">
